...
frmSnowBulb.Timer1.Enabled = False
frmSnowBulb.Timer2.Enabled = False
frmSnowBulb.Picture = frmSnowBulb.Picture3.Picture
...
'it, creating a new region
    hRgn = GetBitmapRegion(frmSnowBulb.Picture, CommonDialog1.Color)
'Set the Forms new Region
    SetWindowRgn frmSnowBulb.hwnd, hRgn, True
End Sub
