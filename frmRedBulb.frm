...
'it, creating a new region
    hRgn = GetBitmapRegion(frmRedBulb.Picture, CommonDialog1.Color)
'Set the Forms new Region
    SetWindowRgn frmRedBulb.hwnd, hRgn, True
End Sub
