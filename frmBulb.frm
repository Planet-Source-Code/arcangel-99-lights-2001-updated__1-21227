...
SetRegion
frmOptions.Show
If frmOptions.Option1.Value = True Then
Timer1.Interval = frmOptions.Text1.Text
Timer2.Interval = frmOptions.Text1.Text
End If
If frmOptions.Option2.Value = True Then
